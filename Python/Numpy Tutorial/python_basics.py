# -*- coding: utf-8 -*-
"""
Created on Sun Jan 16 17:22:17 2022

@author: User
"""

""" Basic Pythond data type"""
# Numbers
#################################################
x = 3
...
# Booleans
##################################################
# Note python uses english words rahter than &&，||, etc
t = True 
f = False
...
s = "hello" # string objects have a bunch of useful methods
...
for idx, animal in enumerate(animals):
    print('#%d: %s' % (idx + 1, animal)) # Prints "#1: fish", "#2: dog", "#3: cat" (eveytime the order is differnet since a set is unordered)
