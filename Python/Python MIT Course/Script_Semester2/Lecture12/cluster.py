...
class Example(object):
    ...
    def distance(self, other):
        return minkowskiDist(self.features, other.getFeatures(), 2) # eucliean distance for p=2 
...
class Cluster(object):
    ...
    def update(self, examples):
        ...
        self.examples = examples # updata new examples
    ...
    def computeCentroid(self):
        ...
        for e in self.examples: #compute mean
            vals += e.getFeatures()
        centroid = Example('centroid', vals/len(self.examples)) # centorid object
        return centroid
